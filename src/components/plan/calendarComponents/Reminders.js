    ...
    <div className="reminders_container">
      <div className="reminder_switch_container">
        ...
        <div className="reminder_options">
          <div ref={oneWeekSwitch} className="theme-switch" onClick={(e) => handleToggleSwitch(e, oneWeekSwitch, "1 Week")}>
      ...
      <div className="reminder_switch_container">
        ...
        <div className="reminder_options">
          <div ref={oneDaySwitch} className="theme-switch" onClick={(e) => handleToggleSwitch(e, oneDaySwitch, "1 Day")}>
            <div className="switch"></div>
          </div>
        </div>
          </div>
      ...
      <div className="reminder_switch_container">
        ...
        <div className="reminder_options">
          <div ref={oneHourSwitch} className="theme-switch" onClick={(e) => handleToggleSwitch(e, oneHourSwitch, "1 Hour")}>
            <div className="switch"></div>
          </div>
        </div>
      </div>
